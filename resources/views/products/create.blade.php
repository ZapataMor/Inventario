                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="descripcion" 
                                      id="descripcion"
                                      rows="3"
                                      class="w-full px-3 py-2 border border-zinc-300 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white placeholder-zinc-500 dark:placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('descripcion') border-red-500 @enderror">{{ old('descripcion') }}</textarea>
                            @error('descripcion')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Precio por Unidad -->
                            <div>
                                <label for="precio_por_unidad" class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-2">
                                    Precio por Unidad ($)
                                </label>
                                <input type="number" 
                                       name="precio_por_unidad" 
                                       id="precio_por_unidad"
                                       value="{{ old('precio_por_unidad', 0) }}"
                                       min="0"
                                       step="0.01"
                                       required
                                       class="w-full px-3 py-2 border border-zinc-300 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white placeholder-zinc-500 dark:placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('precio_por_unidad') border-red-500 @enderror">
