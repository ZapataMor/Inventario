<x-layouts.app title="Usuarios">
    <div class="p-6">
        <div class="mb-6">
            ...
            <p class="text-sm text-zinc-600 dark:text-zinc-400">Gestiona los usuarios del sistema</p>
                ...
                <table class="w-full">
                    <thead class="bg-zinc-50 dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-700">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Fecha de Registro</th>
                    ...
                    <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                        @foreach($users as $user)
                            <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-900/50">
                                <td class="px-6 py-4 text-sm text-zinc-900 dark:text-white">#{{ $user->id }}</td>
                                ...
                                <td class="px-6 py-4 text-sm text-zinc-600 dark:text-zinc-400">{{ $user->created_at->format('d/m/Y') }}</td>
                                <td class="px-6 py-4">
